...
export default function App() {
    ...
    const renderView = () => {
        ...
        switch (currentView) {
            ...
            case 'view:cash_closing': return <CashClosingView invoices={invoices} expenses={expenses} currentUser={authSession?.user as any} company={activeSucursal} canManage={canManageApp} activeCashSession={activeCashSession} onSessionClosed={() => refetchCashSession()} onOpenSession={() => setIsCashOpeningModalOpen(true)} />;
