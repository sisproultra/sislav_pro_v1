import { 
  ...
  Smartphone, FileBarChart, ArrowRight, Phone, Beaker, ShieldCheck, RotateCw, PencilLine
} from 'lucide-react';
...
const SidebarItem: React.FC<SidebarItemProps> = ({ 
  ...
  return (
    ...
    >
      ...
      {isSidebarOpen && badge && (<span className="ml-auto px-1.5 py-0.5 rounded bg-accent text-[7px] font-bold text-white animate-blink-badge shadow-sm">{badge}</span>)}
      ...
      <aside className={`fixed inset-y-0 left-0 z-50 transition-all duration-500 ease-in-out flex flex-col md:relative border-r ${isDarkMode ? 'bg-bg2 border-border shadow-2xl' : 'bg-white border-slate-100 shadow-xl'} ${isSidebarOpen ? 'w-[220px] translate-x-0' : 'w-24 -translate-x-full md:w-20 md:translate-x-0'}`}>
        ...
        <div className="p-3 space-y-4 flex-1 overflow-y-auto no-scrollbar">
          ...
          <nav className="space-y-0.5">
            ...
            <SidebarItem id="view:agenda" icon={Calendar} label="Mi Agenda" isVisible={getModuleConfig('view:agenda').isVisible} badge={getModuleConfig('view:agenda').isNew ? 'NUEVO' : undefined} currentView={currentView} sidebarSearch={sidebarSearch} setView={setView} isSidebarOpen={isSidebarOpen} setIsSidebarOpen={setIsSidebarOpen} isDarkMode={isDarkMode} primaryColor={primaryColorFromDoc} />
            ...
            <SidebarItem id="view:inventory" icon={ShoppingBasket} label="Servicios" isVisible={getModuleConfig('view:inventory').isVisible} currentView={currentView} sidebarSearch={sidebarSearch} setView={setView} isSidebarOpen={isSidebarOpen} setIsSidebarOpen={setIsSidebarOpen} isDarkMode={isDarkMode} primaryColor={primaryColorFromDoc} />
            <SidebarItem id="view:clients" icon={Users} label="Clientes" isVisible={getModuleConfig('view:clients').isVisible} currentView={currentView} sidebarSearch={sidebarSearch} setView={setView} isSidebarOpen={isSidebarOpen} setIsSidebarOpen={setIsSidebarOpen} isDarkMode={isDarkMode} primaryColor={primaryColorFromDoc} />
            <SidebarItem id="view:employees" icon={User} label="Empleados" isVisible={getModuleConfig('view:employees').isVisible} currentView={currentView} sidebarSearch={sidebarSearch} setView={setView} isSidebarOpen={isSidebarOpen} setIsSidebarOpen={setIsSidebarOpen} isDarkMode={isDarkMode} primaryColor={primaryColorFromDoc} />
            <SidebarItem id="view:expenses" icon={BadgeDollarSign} label="Egresos" isVisible={getModuleConfig('view:expenses').isVisible} currentView={currentView} sidebarSearch={sidebarSearch} setView={setView} isSidebarOpen={isSidebarOpen} setIsSidebarOpen={setIsSidebarOpen} isDarkMode={isDarkMode} primaryColor={primaryColorFromDoc} />

            <NavSection label="Logística" isSidebarOpen={isSidebarOpen} />
            <SidebarItem id="view:machines" icon={WashingMachine} label="Máquinas" isVisible={getModuleConfig('view:machines').isVisible} currentView={currentView} sidebarSearch={sidebarSearch} setView={setView} isSidebarOpen={isSidebarOpen} setIsSidebarOpen={setIsSidebarOpen} isDarkMode={isDarkMode} primaryColor={primaryColorFromDoc} />
            <SidebarItem id="view:logistics_hub" icon={Truck} label="Logística Hub" isVisible={getModuleConfig('view:logistics_hub').isVisible} currentView={currentView} sidebarSearch={sidebarSearch} setView={setView} isSidebarOpen={isSidebarOpen} setIsSidebarOpen={setIsSidebarOpen} isDarkMode={isDarkMode} primaryColor={primaryColorFromDoc} />
            <SidebarItem id="view:callcenter" icon={Headset} label="Call Center" isVisible={getModuleConfig('view:callcenter').isVisible} currentView={currentView} sidebarSearch={sidebarSearch} setView={setView} isSidebarOpen={isSidebarOpen} setIsSidebarOpen={setIsSidebarOpen} isDarkMode={isDarkMode} primaryColor={primaryColorFromDoc} />
            <SidebarItem id="view:delivery" icon={Truck} label="Delivery" isVisible={getModuleConfig('view:delivery').isVisible} currentView={currentView} sidebarSearch={sidebarSearch} setView={setView} isSidebarOpen={isSidebarOpen} setIsSidebarOpen={setIsSidebarOpen} isDarkMode={isDarkMode} primaryColor={primaryColorFromDoc} />
            <SidebarItem id="view:supplies" icon={Beaker} label="Insumos" isVisible={getModuleConfig('view:supplies').isVisible} currentView={currentView} sidebarSearch={sidebarSearch} setView={setView} isSidebarOpen={isSidebarOpen} setIsSidebarOpen={setIsSidebarOpen} isDarkMode={isDarkMode} primaryColor={primaryColorFromDoc} />
            <SidebarItem id="view:purchases" icon={ShoppingCart} label="Compras" isVisible={getModuleConfig('view:purchases').isVisible} currentView={currentView} sidebarSearch={sidebarSearch} setView={setView} isSidebarOpen={isSidebarOpen} setIsSidebarOpen={setIsSidebarOpen} isDarkMode={isDarkMode} primaryColor={primaryColorFromDoc} />
            <SidebarItem id="view:package_inventory" icon={PackageOpen} label="Inv. Paquetes" isVisible={getModuleConfig('view:package_inventory').isVisible} currentView={currentView} sidebarSearch={sidebarSearch} setView={setView} isSidebarOpen={isSidebarOpen} setIsSidebarOpen={setIsSidebarOpen} isDarkMode={isDarkMode} primaryColor={primaryColorFromDoc} />
            <SidebarItem id="view:product_counting" icon={Boxes} label="Conteo Inventario" isVisible={getModuleConfig('view:product_counting').isVisible} currentView={currentView} sidebarSearch={sidebarSearch} setView={setView} isSidebarOpen={isSidebarOpen} setIsSidebarOpen={setIsSidebarOpen} isDarkMode={isDarkMode} primaryColor={primaryColorFromDoc} />

            <NavSection label="Marketing" isSidebarOpen={isSidebarOpen} />
            <SidebarItem id="view:loyalty" icon={Ticket} label="Fidelización" isVisible={getModuleConfig('view:loyalty').isVisible} currentView={currentView} sidebarSearch={sidebarSearch} setView={setView} isSidebarOpen={isSidebarOpen} setIsSidebarOpen={setIsSidebarOpen} isDarkMode={isDarkMode} primaryColor={primaryColorFromDoc} />
            <SidebarItem id="view:bonus_points" icon={Star} label="Puntos Bonus" isVisible={getModuleConfig('view:bonus_points').isVisible} currentView={currentView} sidebarSearch={sidebarSearch} setView={setView} isSidebarOpen={isSidebarOpen} setIsSidebarOpen={setIsSidebarOpen} isDarkMode={isDarkMode} primaryColor={primaryColorFromDoc} />
            <SidebarItem id="view:promotions" icon={Sparkles} label="Promociones" isVisible={getModuleConfig('view:promotions').isVisible} currentView={currentView} sidebarSearch={sidebarSearch} setView={setView} isSidebarOpen={isSidebarOpen} setIsSidebarOpen={setIsSidebarOpen} isDarkMode={isDarkMode} primaryColor={primaryColorFromDoc} />
            <SidebarItem id="view:wa_campaign" icon={Megaphone} label="Campaña WA" isVisible={getModuleConfig('view:wa_campaign').isVisible} currentView={currentView} sidebarSearch={sidebarSearch} setView={setView} isSidebarOpen={isSidebarOpen} setIsSidebarOpen={setIsSidebarOpen} isDarkMode={isDarkMode} primaryColor={primaryColorFromDoc} />

            <NavSection label="Administración" isSidebarOpen={isSidebarOpen} />
            <SidebarItem id="view:modificaciones" icon={PencilLine} label="Modificar" isVisible={getModuleConfig('view:modificaciones').isVisible} currentView={currentView} sidebarSearch={sidebarSearch} setView={setView} isSidebarOpen={isSidebarOpen} setIsSidebarOpen={setIsSidebarOpen} isDarkMode={isDarkMode} primaryColor={primaryColorFromDoc} />
            <SidebarItem id="view:categories" icon={Layers} label="Categorías" isVisible={getModuleConfig('view:categories').isVisible} currentView={currentView} sidebarSearch={sidebarSearch} setView={setView} isSidebarOpen={isSidebarOpen} setIsSidebarOpen={setIsSidebarOpen} isDarkMode={isDarkMode} primaryColor={primaryColorFromDoc} />
            <SidebarItem id="view:payment_methods" icon={CreditCard} label="Pagos" isVisible={getModuleConfig('view:payment_methods').isVisible} currentView={currentView} sidebarSearch={sidebarSearch} setView={setView} isSidebarOpen={isSidebarOpen} setIsSidebarOpen={setIsSidebarOpen} isDarkMode={isDarkMode} primaryColor={primaryColorFromDoc} />
            <SidebarItem id="view:reports" icon={FileBarChart} label="Reportes" isVisible={getModuleConfig('view:reports').isVisible} currentView={currentView} sidebarSearch={sidebarSearch} setView={setView} isSidebarOpen={isSidebarOpen} setIsSidebarOpen={setIsSidebarOpen} isDarkMode={isDarkMode} primaryColor={primaryColorFromDoc} />
            ...
            <SidebarItem id="view:settings" icon={Settings} label="Ajustes" isVisible={getModuleConfig('view:settings').isVisible} currentView={currentView} sidebarSearch={sidebarSearch} setView={setView} isSidebarOpen={isSidebarOpen} setIsSidebarOpen={setIsSidebarOpen} isDarkMode={isDarkMode} primaryColor={primaryColorFromDoc} />

            <NavSection label="Sistema" isSidebarOpen={isSidebarOpen} />
            <SidebarItem id="DEV_CONFIG" icon={Terminal} label="Config, Developer" isVisible={getModuleConfig('DEV_CONFIG').isVisible} currentView={currentView} sidebarSearch={sidebarSearch} setView={setView} isSidebarOpen={isSidebarOpen} setIsSidebarOpen={setIsSidebarOpen} isDarkMode={isDarkMode} primaryColor={primaryColorFromDoc} />
          </nav>
        </div>
